...
function render() {
  ...
  try {
    ...
    app.innerHTML = `<div class="login"><div class="card login-card"><h2>Error cargando la app</h2><p class="muted">Abre la consola del navegador y recarga la página.</p><div style="margin-top:16px"><button id="local-btn" class="btn" style="width:100%">Usar sin cuenta</button></div></div></div>`;
    bindEvents();
  }
}
function bindEvents() {
